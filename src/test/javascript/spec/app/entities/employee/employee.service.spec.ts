...
describe('Service Tests', () => {
  describe('Employee Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Employee(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, currentDate, 'AAAAAAA', 0, Status.Activo);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            birthdayDate: currentDate.format(DATE_TIME_FORMAT),
